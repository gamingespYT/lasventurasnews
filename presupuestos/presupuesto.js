...
function showSearchInterface() {
  ...
  document.body.innerHTML = `
    ...
    <style>
      ...
      .recent-item-number { font-weight: 700; color: #ffffff; font-size: 0.85rem; }
      .recent-item-date { font-size: 0.75rem; color: #94a3b8; margin-top: 2px; }
      .recent-item-customer { font-size: 0.8rem; color: #cbd5e1; margin-top: 2px; }
